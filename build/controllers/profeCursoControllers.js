...
class ProfeCursoController {
    list(req, resp) {
        return __awaiter(this, void 0, void 0, function* () {
            const prfCur = yield database_1.default.query('SELECT * FROM Profesor_Curso');
            resp.json(prfCur);
        });
    }
    getOne(req, resp) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const prfCur = yield database_1.default.query('SELECT * FROM Profesor_Curso Where cveProfesorCurso = ?', [cveProfesorCurso]);
            if (prfCur.length > 0) {
    ...
    delete(req, resp) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const prfCur = yield database_1.default.query('DELETE FROM Profesor_Curso Where cveProfesorCurso = ?', [cveProfesorCurso]);
