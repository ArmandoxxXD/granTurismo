...
class UsuariosController {
    ...
    getOne(req, resp) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const usuarios = yield database_1.default.query('SELECT * FROM usuarios Where iduser = ?', [iduser]);
    ...
    delete(req, resp) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const usuarios = yield database_1.default.query('DELETE FROM usuarios Where iduser = ?', [iduser]);
